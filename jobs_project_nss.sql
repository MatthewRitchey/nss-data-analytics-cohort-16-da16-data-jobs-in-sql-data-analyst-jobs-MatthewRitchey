...
SELECT COUNT (*)
FROM data_analyst_jobs
WHERE location LIKE ('TN'); --21 in TN

SELECT COUNT (*)
FROM data_analyst_jobs
WHERE location LIKE ('KY'); --6 in KY
...
--   - Which three industries are in the top 3 on this list? How many jobs have been listed for more than 3 weeks for each of the top 3?The dataset for this exercise has been derived from the `Indeed Data Scientist/Analyst/Engineer` [dataset](https://www.kaggle.com/elroyggj/indeed-dataset-data-scientistanalystengineer) on kaggle.com. 
